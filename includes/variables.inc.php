...
define('TIME_DEFAULT_FORMAT_TO_DISPLAY_WITH_SECONDS', 'H:i:s');
...
define('MINUTES_PER_BOOKING_CHUNK_IN_OVERVIEW', 15);
...
define('MINIMUM_DAYS_UNTIL_MEETING_STARTS_WHERE_YOU_CAN_STILL_PLACE_AN_ORDER', 7);

	// refresh timers (seconds)
define('SECONDS_BEFORE_REFRESHING_BOOKING_PAGE', 30);
define('SECONDS_BEFORE_REFRESHING_MEETINGROOM_PAGE', 30);
define('SECONDS_BEFORE_REFRESHING_ADMIN_PAGES', 30);
...
define('MAX_NUMBER_OF_EMAILS_TO_SEND_AT_ONCE', 20); // Runs once per minute
