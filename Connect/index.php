...
// Which also holds the early tests for the LOG EVENTS folder
// with the ability to add a log to the database
// which is no longer needed as we've seen it works
