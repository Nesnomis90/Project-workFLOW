...
INSERT INTO `booking`(`meetingRoomID`, `userID`, `displayName`, `startDateTime`, `endDateTime`, `description`) VALUES (<meetingroomID>, <userID>, 'DisplayName', '2017-03-15 16:00:00', '2017-03-15 17:30:00', 'Booking Description');
...
INSERT INTO `employee`(`CompanyID`, `UserID`, `PositionID`) VALUES (<companyID>, <userID>, (SELECT `PositionID` FROM `companyposition` WHERE `name` = 'Employee'));
...
SELECT u.firstName, u.lastName, cp.`name` FROM `company` c JOIN `companyposition` cp JOIN `employee` e JOIN `user` u WHERE u.userID = e.UserID AND e.CompanyID = c.CompanyID AND cp.PositionID = e.PositionID AND c.`name` = 'test1';
...
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `userID` = <userID> AND `isActive` = 1;
#SELECT THE USER INFORMATION BASED ON THE SELECTED USER, IF ACCOUNT IS INACTIVE
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `userID` = <userID> AND `isActive` = 0;
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT ARE ACTIVE
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `isActive` = 1;
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT ARE INACTIVE
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `isActive` = 0;
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT HAS A FIRST AND LASTNAME THAT CONTAINS THE SEARCHED STRING
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `firstName` LIKE '%SomeLetters%' AND `lastName` LIKE '%SomeLetters%';
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT HAS A FIRST AND LASTNAME THAT MATCHES EXACTLY THE SEARCHED STRING
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `firstName` = 'SomeLetters' AND `lastName` = 'SomeLetters';
...
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `email` LIKE '%SomeLetters%';
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT HAS AN EMAIL THAT MATCHES EXACTLY THE SEARCHED STRING
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `email` = 'SomeLetters';
...
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `create_time` < 'Some Date in the year-month-day format';
...
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `create_time` LIKE 'Some Date in the year-month-day format%';
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT HAVE A DISPLAY NAME THAT CONTAINS THE SEARCHED STRING
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `displayName` LIKE '%SomeLetters%';
#SELECT THE USER INFORMATION FOR ALL ACCOUNTS THAT HAVE A DEFAULT BOOKING DESCRIPTION THAT CONTAINS THE SEARCHED STRING
SELECT `firstname`, `lastname`, `email`, `displayname`, `bookingdescription`, `create_time` FROM `user` WHERE `bookingDescription` LIKE '%SomeLetters%';
#
